...
const props = defineProps({
    ...
    theme: {
        ...
        default: () => ({
            buttonClass:
                'bg-blue-500 text-white font-bold py-2 px-4 rounded transition-all hover:bg-blue-700 shadow-lg',
            progressClass:
                'bg-blue-400 h-2 rounded-full transition-all duration-500',
            cancelClass:
                'bg-red-500 text-white font-bold py-2 px-4 rounded ml-2 hover:bg-red-600',
        }),
    },
    readonly: {
        type: Boolean,
